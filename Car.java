...
public class Car extends Frame {
    ...
    public void paint(Graphics g) {
        ...
        // Set the stroke to dashed line
        float[] dashPattern = { 10, 5 }; // 10 pixels on, 5 pixels off
        g2d.setStroke(new BasicStroke(3.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, dashPattern, 0.0f));
